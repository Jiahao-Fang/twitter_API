# -*-coding:utf-8-*-
# ---
# @Fila: scrapping_through_sitemap.py
# @Author: Jiahao Fang
# @Date: 2022/10/28
# @Description:
# @Project: cointelegraph-news
...
# scrape the content in each page
for i in range(1,n_agg_pages+1): # number of content-aggregating pages from https://cointelegraph.com/sitemap.xml
    ...
    for item in all_links:
        ...
        # csv
        with open(file_to_store_news, 'a', encoding = 'utf-8-sig') as csv_file:
            writer = csv.writer(csv_file)
